...
\end{description}
% I think the way to do this is to instead have a section for each function/algorithm, which includes the derivation and then the algorithm and briefly explain it.
